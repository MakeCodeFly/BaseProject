...
public class SpannyTextView extends SpannableStringBuilder {
    ...
    public SpannyTextView() {
        super("");
    }

    public SpannyTextView(CharSequence text) {
        super(text);
    }

    public SpannyTextView(CharSequence text, Object... spans) {
        super(text);
    ...
    public SpannyTextView(CharSequence text, Object span) {
        super(text);
     ...
     * @return this {@code SpannyTextView}.
     */
    public SpannyTextView append(CharSequence text, Object... spans) {
        append(text);
        for (Object span : spans) {
    ...
    public SpannyTextView append(CharSequence text, Object span) {
        append(text);
        setSpan(span, length() - text.length(), length());
        return this;
    }
     ...
     * @return this {@code SpannyTextView}.
     */
    public SpannyTextView append(CharSequence text, ImageSpan imageSpan) {
        text = "." + text;
        append(text);
     ...
     * @return this {@code SpannyTextView}.
     */
    @Override public SpannyTextView append(CharSequence text) {
        super.append(text);
        return this;
    }
     ...
     */
    @Deprecated public SpannyTextView appendText(CharSequence text) {
        append(text);
        return this;
    }
     ...
     * @return {@code SpannyTextView}.
     */
    public SpannyTextView findAndSpan(CharSequence textToSpan, GetSpan getSpan) {
        int lastIndex = 0;
        while (lastIndex != -1) {
    ...
    /**
     * Sets span objects to the text. This is more efficient than creating a new instance of SpannyTextView
